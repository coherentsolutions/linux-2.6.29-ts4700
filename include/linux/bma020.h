 ...
 * values.<br>
 * Example: BMA020_LG_THRES_IN_G( 0.3, 2.0) generates the register value for
 * 0.3G threshold in 2G mode.
 ...
 * values.<br>
 * Example: BMA020_HG_THRES_IN_G( 1.4, 2.0) generates the register value for
 * 1.4G threshold in 2G mode.
 * \brief convert g-values to 8-bit value
 */
#define BMA020_HG_THRES_IN_G(gthres, range)		((int)((256 * gthres) / range))

/** Macro to convert floating point low-g-hysteresis in G to 3-bit register
 * values.<br>
...
/** Macro to convert floating point high-g-hysteresis in G to 3-bit register
 * values.<br>
...
*/
/* static int __devinit bma020_i2c_probe(struct i2c_client*); */
...
/* MA020_ANY_MOTION_DUR_1, BMA020_ANY_MOTION_DUR_3, BMA020_ANY_MOTION_DUR_5,
 * BMA020_ANY_MOTION_DUR_7
 */
